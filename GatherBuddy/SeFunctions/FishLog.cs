...
public unsafe class FishLog
{
    ...
    private static bool CheckForChanges(byte* ptr, byte[] data, int num)
    {
        ...
        {
            if (Utility.Util.MemCmpUnchecked(ptr, ptr2, num))
                return false;
        }
    ...
    public bool CheckForChanges()
        => CheckForChanges(_fish, _fishStore, _fishStore.Length) || CheckForChanges(_spearFish, _spearFishStore, _spearFishStore.Length);
