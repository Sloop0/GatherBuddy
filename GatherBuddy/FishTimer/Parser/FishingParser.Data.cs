...
public partial class FishingParser
{
    ...
    private static Dictionary<string, FishingSpot> SetupFishingSpotNames()
        => GatherBuddy.Language == ClientLanguage.German
            ...
            : GatherBuddy.GameData.FishingSpots.Values.ToDictionary(fs => fs.Name.ToLowerInvariant(), fs => fs);
    ...
    {
        var ret            = new Dictionary<string, FishingSpot>(GatherBuddy.GameData.FishingSpots.Count * 3);
